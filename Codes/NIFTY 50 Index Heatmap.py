...
nifty = yf.download(index_ticker, start="2018-01-01", end="2025-03-01", auto_adjust=False, progress=False)
...
# Titles and Labels
plt.title(f"Monthly Returns Heatmap for NIFTY 50 - {index_ticker} (2018-2025)")
plt.xlabel("Year")
plt.ylabel("Month")
plt.show()